        ...
        child: Container(
          ...
          child: Row(
            children: [
              ...
              //     color: textGrayScalePurpleColor, size: 16.sp)
            ],
          ),
        ),
      ),
...
class _SearchDialogState<T> extends State<SearchDialog> {
  ...
  Color randomColor() =>
      Color((Random().nextDouble() * 0xFFFFFF).toInt() << 0).withOpacity(0.15);
                    ...
                    itemBuilder: (context, index) {
                      return InkWell(
                          onTap: () {
                            ...
                            Navigator.pop(context, filteredList[index]['name']);
                          },
                          child: Padding(
...
class CustomDialog extends StatelessWidget {
  ...
  const CustomDialog({
    ...
    this.constraints = const BoxConstraints(
        // minWidth: 280.0, minHeight: 280.0, maxHeight: deviceHeight(context), maxWidth: deviceWidth(context)),
        minWidth: 280.0,
        minHeight: 280.0,
        maxHeight: 400.0,
        maxWidth: 400.0),
